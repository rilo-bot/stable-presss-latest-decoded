...
import { Plus, Sparkles, FileUp, FilePlus, X, Loader2, FileText, FileScan, Globe, EyeOff, Trash2 } from 'lucide-react';
...
export default function MagazineV2Home() {
  ...
  // Delete a magazine (and its published Bulletins edition, server-side).
              ...
              <div key={it.id} className="flex flex-col rounded border border-border p-4 hover:border-[#7c3aed]">
                ...
                <div className="mt-3 flex items-center gap-2 border-t border-border pt-2.5">
                  ...
                  <button
                    ...
                    disabled={busy}
                    className="ml-auto inline-flex items-center gap-1 rounded px-2 py-1 text-xs text-red-600 hover:bg-red-50 disabled:opacity-50"
