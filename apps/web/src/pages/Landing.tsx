  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative h-[75vh] min-h-[520px] max-h-[780px]">
          <img
          ...
          <div className="absolute top-6 left-6 md:left-12 flex items-center gap-2">
            <span
              className="text-[9px] uppercase tracking-[0.22em] font-bold px-2.5 py-1"
              style={{
                background: 'hsl(var(--brand-accent))',
                color: 'hsl(var(--brand-accent-foreground))',
              }}
            ...
            <span className="text-[9px] uppercase tracking-[0.14em] font-semibold text-primary-foreground/60">
              Race Report
            </span>
          </div>

          {/* Hero content */}
          <div className="absolute bottom-0 left-0 right-0 px-6 pb-8 md:px-12 md:pb-12 max-w-5xl">
            {heroArticle ? (
              <>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  />
                  <span className="text-[10px] uppercase tracking-[0.14em] font-semibold text-primary-foreground/60">
                ...
                <motion.h1
                  ...
                  className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-[1.08] mb-5 max-w-3xl"
                >
                  {heroArticle.title}
                </motion.h1>
                <p className="text-sm md:text-base text-primary-foreground/75 leading-relaxed max-w-2xl mb-6 line-clamp-2">
                  {heroArticle.summary}
                </p>
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2 text-xs font-semibold uppercase tracking-[0.1em] rounded-sm transition-colors"
                    style={{
                      background: 'hsl(var(--brand-accent))',
                      color: 'hsl(var(--brand-accent-foreground))',
                    }}
                  >
                    Read in full <ArrowRight size={12} />
                  </Link>
                </div>
              </>
            ) : (
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.22, ease: 'easeOut' }}
                className="font-[family-name:var(--font-display)] text-5xl font-bold text-primary-foreground leading-tight mb-4"
              >
                The Turf Awaits
              </motion.h1>
            )}
      ...
      <div className="bg-primary text-primary-foreground border-b border-primary/80">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-wrap items-stretch divide-x divide-primary-foreground/10">
            {MEMBER_METRICS.map((metric) => (
              <div
                key={metric.label}
                className="flex items-center gap-3 px-4 md:px-6 py-3 flex-1 min-w-[130px]"
              >
                <span className="opacity-50">{metric.icon}</span>
                <div>
                  <span
                    className="block font-[family-name:var(--font-display)] text-lg font-bold tabular-nums leading-none"
                    style={{ color: 'hsl(var(--brand-accent))' }}
                  >
                    {metric.value}
                  </span>
                  <span className="block text-[9px] uppercase tracking-[0.1em] text-primary-foreground/50 mt-0.5">
                    {metric.label}
                  </span>
                </div>
              </div>
