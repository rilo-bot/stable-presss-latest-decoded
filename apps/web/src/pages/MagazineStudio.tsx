 ...
 * (`/newsroom/magazine/:id`), separate from the Newsroom workflow page. This makes
...
export default function MagazineStudio() {
  ...
  if (!id) return <Navigate to="/newsroom" replace />;

  return <MagazineEditor magazineId={id} onClose={() => navigate('/newsroom')} />;
}
